...
export default async function sendEmail(email: string, url: string) {
  ...
  const mailOptions = {
    ...
    html: `<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<tbody><tr>
		<td align="center" valign="top" bgcolor="#414858" style="background-size:cover; background-position:top;">
	...
	WELCOME <span style="font-family: 'Raleway', sans-serif; font-size:37px; color:#ffffff; line-height:39px; font-weight: 300; letter-spacing: 5px;">IN THE MANAGEMENT SYSTEM</span>
		</td>
		</tr>
		...
		<tr>
		<td align="center" style="font-family: 'Raleway', sans-serif; font-size:22px; font-weight: bold; color:#333;">To confirm your account just click this link below</td>
		</tr>
		...
		<tr>
		<td align="center" style="font-family: 'Lato', sans-serif; font-size:14px; color:#757575; line-height:24px; font-weight: 300; border-bottom: 1px solid grey; padding-bottom: 1em">
            <a href="${url}" style="text-decoration: none; color: #414858; font-weight: 600;">Confirm email</a>
		</td>
		</tr>
